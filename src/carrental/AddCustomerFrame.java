...
public class AddCustomerFrame extends javax.swing.JFrame {
	...
	public AddCustomerFrame() {
		initComponents();
		AddCustomerStateModel acm = (AddCustomerStateModel) jComboBox1.getModel();
		acm.addCountries();
	}
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(carrental.CarRentalApp.class).getContext().getResourceMap(AddCustomerFrame.class);
        ...
        jComboBox1.setModel(new carrental.AddCustomerStateModel());
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
		...
		if ((o != null) && (houseNumber != 0)) {
			...
			Customer customer;
			String forename = jTextField1.getText();
			String surname = jTextField2.getText();
			String street = jTextField3.getText();
			String town = jTextField5.getText();
			...
			try {
				customer = cmi.createNewCustomer(forename, surname, addr);
